...
from schemas.employee_schema import EmployeeCreate, EmployeeIDResponse, EmployeeResponse
...
def get_all_employees(db: Session = Depends(get_db)):
    ...
    #if employees length is non zero then return the employees else throw exception
    if len(employees)> 0:
        return employees
    #return 404 not found error if employees length is zero
